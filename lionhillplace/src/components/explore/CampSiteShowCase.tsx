...
function importAllImages() {
  const images = import.meta.glob("/src/assets/camp/*.{jpg,jpeg,png}", {
    eager: true,
    import: "default",
  });
...
const CampSiteShowCase = () => {
  ...
  const handleMakeReservation = () => {
    window.location.href = `/book?bookingType=campsite`;
  };
  ...
  const amenities = [
    ...
    "Clean restrooms", 
    "Charging stations",
    "Shared kitchen and fire pit",
    "Optional meals and breakfast",
    "Pet-friendly · Safe parking"
  ];
    ...
    <section className="relative py-20 px-4 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 bg-white/10 dark:bg-zinc-700/30 backdrop-blur-md border border-white/20 dark:border-black/20 px-4 py-2 rounded-full text-white font-medium mb-6 shadow-xl">
          ...
          <p className="text-gray-200 dark:text-gray-300 text-base leading-relaxed max-w-3xl mx-auto drop-shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-12 max-w-4xl mx-auto">
          {amenities.map((amenity, idx) => (
            <div
              key={idx}
              className="flex items-center gap-3 bg-white/5 dark:bg-zinc-700/20 backdrop-blur-md rounded-xl p-4 shadow-2xl border border-white/10 dark:border-black/20 hover:bg-white/10 hover:dark:bg-zinc-600/30 hover:border-white/20 dark:hover:border-black/30 transition-all duration-300 group"
            >
              <TbTagsFilled className="text-black dark:text-white w-6 h-6" />
          ...
          <div className="mb-10">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
              {galleryImages.slice(0, 8).map((img, idx) => (
                <div 
                  key={idx}
                  className="group relative overflow-hidden rounded-2xl shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer border border-white/10 dark:border-black/10"
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="bg-white/20 dark:bg-black/30 backdrop-blur-md rounded-full p-3 border border-white/30 dark:border-black/30 shadow-xl">
