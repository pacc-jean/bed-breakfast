...
const EventSpaceShowCase = () => {
  ...
  const amenities = [
    "Birthdays, baby showers, wellness days",
    "Corporate retreats & family get-togethers", 
    "Shaded sitting areas & open grounds",
    "Optional meals, décor, tents & coordination",
    "On-site group accommodation",
    "Safe parking"
  ];
